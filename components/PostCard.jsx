...
const PostCard = ({post}) => {
  console.log(post);
  return (
  <div className='bg-whhite shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <h1 className='transition duration-800 text-center mb-8 cursor-pointer hover:text-pink-600 text-3xl font-semibold'>
      ...
      <div className='block lg:flex text-center items-center justify-center mb-8 w-full'>
          <div className='flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8'>
              <img alt={post.author.name} height='30' width='30' className='align-middle rounded-full' src={post.author.photo.url}/>
